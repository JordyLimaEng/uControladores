...
MAIN
	...
	BSF  LCD_EN	    ;DESENHA BONECO
	MOVLW	B'00110000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00110000' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
	...
	BSF  LCD_EN	    ;MUDA PARA COLUNA 9 DA LINHA 2
	MOVLW	B'00100011' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00101010' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
	...
	BSF  LCD_EN	    ;MUDA PARA LINHA 1
	MOVLW	B'00100001' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00101011' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
    ...
    gravaBoneco
	BSF  LCD_EN	    ;DEFINE CG_RAM PARA LINHA 1 COLUNA 1 DA RAM
	MOVLW	B'00100010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	...
	BSF  LCD_EN	    ;MANDA BYTE 0
	MOVLW	B'00110000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00110111' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
	BSF  LCD_EN	    ;MANDA BYTE 1
	MOVLW	B'00111000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00111000' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
	BSF  LCD_EN	    ;MANDA BYTE 2
	MOVLW	B'00110000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	...
	BCF  LCD_EN
	CALL delay_100us
	BSF  LCD_EN	    ;MANDA BYTE 3
	MOVLW	B'00111000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00111101' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
	BSF  LCD_EN	    ;MANDA BYTE 4
	MOVLW	B'00110000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00110010' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
	BSF  LCD_EN	    ;MANDA BYTE 5
	MOVLW	B'00110000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00110101' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	CALL delay_100us
	BSF  LCD_EN	    ;MANDA BYTE 6
	MOVLW	B'00111000' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
