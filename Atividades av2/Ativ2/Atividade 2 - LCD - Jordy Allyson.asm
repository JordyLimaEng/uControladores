...
MAIN
	...
	BSF  LCD_EN	    ;ESCREVE J
	MOVLW	B'00110010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	...
	BSF  LCD_EN	    ;ESCREVE O
	MOVLW	B'00110010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00111111' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	
	call  delay_0.5s
	
	BSF  LCD_EN	    ;ESCREVE R
	MOVLW	B'00111010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00110100' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	
	call  delay_0.5s
	
	BSF  LCD_EN	    ;ESCREVE D
	MOVLW	B'00110010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	...
	BSF  LCD_EN	    ;ESCREVE Y
	MOVLW	B'00111010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00111001' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	
	call  delay_40us
	
	BSF  LCD_EN	    ;MUDA PARA LINHA 2
	...
	BSF  LCD_EN	    ;ESCREVE L
	MOVLW	B'00110010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00110011' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	
	call  delay_0.5s
	
	BSF  LCD_EN	    ;ESCREVE I
	MOVLW	B'00110010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	...
	BSF  LCD_EN	    ;ESCREVE M
	MOVLW	B'00110010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
	MOVLW	B'00111011' ;NIBBLE2  
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	
	call  delay_0.5s
	
	BSF  LCD_EN	    ;ESCREVE A
	MOVLW	B'00110010' ;NIBBLE1
	CALL SHIFT_REGISTER
	BCF  LCD_EN
	BSF  LCD_EN
